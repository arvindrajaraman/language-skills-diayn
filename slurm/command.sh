...
#SBATCH --mem=8gb
#SBATCH --qos=default
#SBATCH --output=slurm/1716313908-out.txt
#SBATCH --error=slurm/1716313908-err.txt
...
srun conda run --no-capture-output -n diayn4 python diayn_fast.py -c plant_row/plant_row_diayn_lang.yml
