...
#SBATCH --output=slurm/1716230592-out.txt
#SBATCH --error=slurm/1716230592-err.txt
...
srun conda run --no-capture-output -n diayn4 python diayn_fast.py -c paper/diayn_lang_hybrid.yml
