...
#SBATCH --mem=8gb
#SBATCH --qos=default
#SBATCH --output=slurm/1716102010-out.txt
#SBATCH --error=slurm/1716102010-err.txt
...
srun conda run --no-capture-output -n diayn4 python diayn_fast.py -c paper/diayn_lang_hybrid_50.yml
